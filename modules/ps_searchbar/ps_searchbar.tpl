...
<div class="bloc-recherche">
	<img src="{$urls.base_url}themes/classic/assets/img/search.png" width="24" height="24" class="ico-search">
	<div id="search_widget" class="col-lg-4 col-md-5 col-sm-12 search-widget" data-search-controller-url="{$search_controller_url}">
		<form method="get" action="{$search_controller_url}">
			...
			<button type="submit">
				<i class="material-icons navigate_next ico-input-search">navigate_next</i>
