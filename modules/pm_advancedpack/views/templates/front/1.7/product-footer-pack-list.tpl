					...
					<div class="ap5-pack-product-content">
						...
						<div class="ap5-pack-product-image">
							<a class="no-print" title="{$imageTitle}" href="{$productPack.presentation.url}" target="_blank">
								<img class="img-fluid d-block mx-auto" id="thumb_{$productPack.image.id_image|intval}" src="{$link->getImageLink($productPack.presentation.link_rewrite, $imageIds, $imageFormatProductCover)}" alt="{$imageTitle}" title="{$imageTitle}" height="{$imageFormatProductCoverHeight}" width="{$imageFormatProductCoverWidth}" itemprop="image" />
							</a>
						</div>
